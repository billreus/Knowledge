...
- [3. 线程安全](#3-%E7%BA%BF%E7%A8%8B%E5%AE%89%E5%85%A8)
  - [3.1. 不可变](#31-%E4%B8%8D%E5%8F%AF%E5%8F%98)
  - [3.2. 互斥同步](#32-%E4%BA%92%E6%96%A5%E5%90%8C%E6%AD%A5)
  - [3.3. 非阻塞同步](#33-%E9%9D%9E%E9%98%BB%E5%A1%9E%E5%90%8C%E6%AD%A5)
    - [3.3.1. CAS](#331-cas)
    - [3.3.2. AtomicInteger](#332-atomicinteger)
    - [3.3.3. ABA](#333-aba)
  - [3.4. 无同步方案](#34-%E6%97%A0%E5%90%8C%E6%AD%A5%E6%96%B9%E6%A1%88)
    - [3.4.1. 栈封闭](#341-%E6%A0%88%E5%B0%81%E9%97%AD)
    - [3.4.2. 线程本地存储](#342-%E7%BA%BF%E7%A8%8B%E6%9C%AC%E5%9C%B0%E5%AD%98%E5%82%A8)
- [4. 锁优化](#4-%E9%94%81%E4%BC%98%E5%8C%96)
  - [4.1. 自旋锁](#41-%E8%87%AA%E6%97%8B%E9%94%81)
  - [4.2. 锁消除](#42-%E9%94%81%E6%B6%88%E9%99%A4)
  - [4.3. 锁粗化](#43-%E9%94%81%E7%B2%97%E5%8C%96)
  - [4.4. 轻量级锁](#44-%E8%BD%BB%E9%87%8F%E7%BA%A7%E9%94%81)
  - [4.5. 偏向锁](#45-%E5%81%8F%E5%90%91%E9%94%81)
- [3. 锁](#3-%E9%94%81)
...
![Image text](https://github.com/billreus/Konwledge/blob/master/picture/AQS.png)
...
不可变的对象一定是线程安全的，永远不会看到它在多个线程中处于不一致状态。
...
使用Synchronize和ReentrantLock

## 4.3. 非阻塞同步

互斥同步属于悲观的并发策略会降低性能，为此出现了非阻塞同步。

非阻塞同步即先进行操作，如果没有其它线程争用共享数据，那操作就成功了，否则采取补偿措施。
